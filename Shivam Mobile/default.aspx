        <%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="default.aspx.cs" Inherits="Shivam_Mobile.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="Image/iphone-slider.png" class="d-block w-100"  alt="...">
    </div>
    <div class="carousel-item">
      <img src="Image/oneplus-slider.jpg" class="d-block w-100"  alt="...">
    </div>
    <div class="carousel-item">
      <img src="Image/samsung-slider.jpg " class="d-block w-100" alt="...">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="next">
    ...
    <main class="container-fluidz bg-trasparent my-4 p-3">
        <asp:DataList ID="dlProducts" runat="server" RepeatColumns="4" RepeatLayout="Flow" CssClass="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3" RepeatDirection="Horizontal">
    <ItemTemplate>
        <div class="col">
                ...
                <div class="card-body">                   
                    <h5 class="card-title" style="font-size:19px; font-weight:490;">
                     ...
                     <div class="clearfix mb-3 text-center">
                        <h3> 
                            ₹<asp:Label ID="price" runat="server" Text='<%# Bind("Price") %>'></asp:Label>.00
                    ...
                    <div class="d-flex gap-2 my-3">
                        <asp:Button ID="ck" CssClass="btn btn-warning bold-btn" runat="server" Text="add to cart" Font-Size="20px" CommandArgument='<%# Bind("Id") %>' OnCommand="ck_Command" Width="50%"  />
                         <asp:Button ID="Button1" CssClass="btn btn-success bold-btn" runat="server" Text="Buy Now" CommandArgument='<%# Bind("Id") %>' Font-Size="20px" Width="50%" OnCommand="Button1_Command" />                                  
                            ...
                            <div class="container px-4 px-lg-5">
                                <div class="row gx-4 gx-lg-5 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex">
                                            <asp:Button ID="ck1" CssClass="btn btn-warning bold-btn" runat="server" Text="add to cart" Font-Size="20px" OnClick="ck1_Click" Width="250px" />
